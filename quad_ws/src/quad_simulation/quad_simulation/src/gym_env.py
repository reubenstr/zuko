...
RENDER_HEIGHT = 720
RENDER_WIDTH = 960
SENSOR_NOISE_STDDEV = model.SENSOR_NOISE_STDDEV
...
class GymEnv(gym.Env):
  ...
  """
    ...
    def pass_joint_angles(self, joint_angles):
    ...
    Args:prev_pos
      action: A list of desired motor angles for n motors.
    ...
    """  
        ...
        if self._is_render:
            ...
            [yaw, pitch, dist] = self._pybullet_client.getDebugVisualizerCamera()[
                8:11]
            self._pybullet_client.resetDebugVisualizerCamera(
